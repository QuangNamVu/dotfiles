...
values."
  (setq-default
   ...
   '(
     ...
     ;clang support for large project
     (c-c++ :variables c-c++-enable-clang-support t)

     ; include company and fly check company-check
